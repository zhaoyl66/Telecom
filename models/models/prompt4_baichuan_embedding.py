...
class Prompt(BaiChuanForCausalLM):
    ...
    def __init__(self, config=None,tokenizer=None, max_depth = 1,num_labels=1, graph_type='GAT', layer=1, path_list=None, data_path=None, depth2label=None, max_seg_num=None, max_seq_len=None, device=None, **kwargs):
        ...
        baichuanConfig.hidden_dropout_prob = 0.1
        ...
        # config.hidden_size = self.bertConfig.hidden_size
    ...
    def forward(
        ...
        self.embedding = multiclass_logits.view(num,-1).to(self.device)
        torch.save(self.embedding,'embedding/baichuan_contra/contra'+str(i)+'.pt')

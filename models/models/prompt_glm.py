...
class GraphEmbedding(nn.Module):
    ...
    def forward(self, x):
        # print("weight",type(self.weight()))
        # print("padding_idx",type(self.padding_idx))
        # print("x",type(x))
...
class Prompt(BertPreTrainedModel):
    ...
    def __init__(self, config=None, tokenizer=None, num_labels=None, graph_type='GAT', layer=1, path_list=None, data_path=None, depth2label=None,device=None, **kwargs):

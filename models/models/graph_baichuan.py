...
class GraphLayer(nn.Module):
    def __init__(self, config, graph_type):
        ...
        self.config = config
        print("Graph Layer",self.config.hidden_size)
...
class GraphEncoder(nn.Module):
    def __init__(self, config, graph_type='GAT', layer=1, path_list=None, data_path=None):
        ...
        # print("self.label_num",self.label_num)
        self.graph_type = graph_type
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(r'/data/zyl2023/baichuan-7B',local_files_only=True,trust_remote_code=True)
        # self.tokenizer = AutoTokenizer.from_pretrained(r'/data/zyl2023/bert-base-chinese',local_files_only=True,trust_remote_code=True)
        if self.graph_type == 'graphormer':
